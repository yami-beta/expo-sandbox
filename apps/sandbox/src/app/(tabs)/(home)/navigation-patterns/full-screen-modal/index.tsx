...
export default function FullScreenModalIntermediate(): ReactElement {
  ...
  const sections = [
    ...
    },
    {
      ...
      data: [
        {
          href: "/navigation-patterns/full-screen-modal/on-root-slide-from-bottom",
          text: <Trans>on root + slide_from_bottom</Trans>,
          description: <Trans>デフォルトの戻る ←</Trans>,
        },
        {
          href: "/navigation-patterns/full-screen-modal/on-root-slide-from-bottom-back-hidden",
          text: <Trans>on root + slide_from_bottom + back hidden</Trans>,
          description: <Trans>headerBackVisible: false でヘッダー左を非表示</Trans>,
        },
        {
          href: "/navigation-patterns/full-screen-modal/on-root-slide-from-bottom-close",
          text: <Trans>on root + slide_from_bottom + close icon</Trans>,
          description: <Trans>headerBackIcon でネイティブの戻るグリフを × に差し替え</Trans>,
        },
        {
          href: "/navigation-patterns/full-screen-modal/in-tab-slide-from-bottom",
          text: <Trans>in tab + slide_from_bottom</Trans>,
          description: <Trans>デフォルトの戻る ←</Trans>,
        },
        {
          href: "/navigation-patterns/full-screen-modal/in-tab-slide-from-bottom-back-hidden",
          text: <Trans>in tab + slide_from_bottom + back hidden</Trans>,
          description: <Trans>headerBackVisible: false でヘッダー左を非表示</Trans>,
        },
        {
          href: "/navigation-patterns/full-screen-modal/in-tab-slide-from-bottom-close",
